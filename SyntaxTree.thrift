...
const i64     PROTO_COUNTER  = 027   // pls add this counter when every time you release/push, and reset this counter when you add PROTO_VERsION
...
service AstDumper
{
    ...
    oneway void startExpressionList( ),
        ...
        oneway void startInvokeExpression( 1: CallExpression call ),
        oneway void endInvokeExpression( ),
        ...
        oneway void literalArrayBegin(  ),
        oneway void literalArrayEnd(  ),
    ...
    oneway void startSwitchStatement( ),
    oneway void endSwitchStatement( ),
    ...
    oneway void startCaseLabel( ),
    oneway void endCaseLabel( ),
    oneway void defaultCaseLabel( ),

    oneway void breakStatement( ),
    oneway void continueStatement( ),

    oneway void beginDeleteExpression( 1: string mode),
    oneway void endDeleteExpression( ),

    oneway void empty( ),

	oneway void startStoreRegister(  ),
	oneway void endStoreRegister(),
	oneway void startLoadRegister( ),
	oneway void endLoadRegister( ),

	oneway void registerNode( 1: i32 reg ),

	oneway void startHasNext( ),
	oneway void endHasNext( ),

	oneway void startCoerce( ),
	oneway void endCoerce( ),
}
